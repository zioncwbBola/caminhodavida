...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Caminho da Vida - Igreja Evangélica",
    description:
      "Descubra o amor de Cristo, encontre apoio emocional e viva a mensagem de salvação. Faça parte da Comunidade Cristã Caminho da Vida!",
    url: "https://caminhodavida.vercel.app/",
    type: "website",
    images: [
      {
        url: "https://caminhodavida.vercel.app/brand/300px.png",
        width: 800,
        height: 600,
        alt: "Caminho da Vida - Igreja Evangélica",
      },
      {
        url: "https://caminhodavida.vercel.app/brand/support.png",
        width: 800,
        height: 600,
        alt: "Apoio Emocional e Amor de Cristo",
      },
  ...
  twitter: {
    ...
    description:
      "Descubra o amor de Cristo, encontre apoio emocional e viva a mensagem de salvação. Faça parte da Comunidade Cristã Caminho da Vida!",
    images: ["https://caminhodavida.vercel.app/brand/300px.png"],
  },
  icons: {
    icon: "/favicon/favicon.ico",
    apple: "/favicon/apple-touch-icon.png",
  ...
  manifest: "/favicon/site.webmanifest",
  alternates: {
    canonical: "https://caminhodavida.vercel.app",
  },
  other: {
    "google-site-verification": "f7z7Q-Fme5-I-gy1j0k16sszIaSx8CTDcsxgVWRqKxs",
  },
